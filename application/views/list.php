...
<div id="main">
	...
	.wrap_image_throb
	{
		...
		function validate_filter()
		{
			...
			if(citybox=='' && areabox=='')
			{
				$(".ptext1").html('Please enter search value'); 
...
<script>
  function twshare(url)
  {
			...
			<div class="col-md-10 col-sm-8">
				...
				<section id="CAUSEDETAILS">
					...
					<div class="col-sm-12">
						...
						<div class="row blog-list blog-masonry isotope-masonry cuases_section" style="position: relative;">
										...
										if($flag == 1)
										{
											...
											else
											{
												...
												$ignite_option = '<a href="javascript:">
																	<img src="../images/ignite.png" title="Joined Cause" class="wrap_image_throb">
																</a>';
											}
	...
	{
		$(".ptext1").html('You the admin of this cause'); 
		$("#openModalpopup1").css('display','block'); 
		setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
		return false;
	...
	function cause_action(val,rand)
	{
		...
		{
			var msg = 'Are you sure you want to send the this request?';
		}
		if(confirm(msg)==true)
		{
			...
			$.ajax({
					...
					success: function(result){
							if(result)
							{
								...
								$(".ptext1").html(result); 
								$("#openModalpopup1").css('display','block'); 
								setTimeout(function() { window.location.href = '<?=base_url()?>causes/lists'; }, 2000);
								setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
								return false;
