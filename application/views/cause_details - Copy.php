	...
	if(confirm('Are you sure you want to remove this members from this cause?')==true)
	{
		...
		$.ajax({
				...
				success: function(result){
						if(result)
						{
							$(".ptext1").html('Member Removed sucessfully!!!'); 
...
<script>
	...
	function owner_cause()
	{
		...
		$(".ptext1").html('You are a Owner of this Cause.'); 
		$("#openModalpopup1").css('display','block'); 
		setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
		return false;
	}
	...
	function cause_request()
	{
		...
		$(".ptext1").html('Your Request to join this cause is waiting to approve.'); 
		$("#openModalpopup1").css('display','block'); 
		setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
		return false;
	}
	...
	function max_members()
	{
		...
		$(".ptext1").html('Maximum Volunters already assigned!!!'); 
		$("#openModalpopup1").css('display','block'); 
		setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
		return false;
	}
                    ...
                    <script type="text/javascript">
								...
								$.ajax({
										...
										success: function(result){
												if(result)
												{
													...
													$(".ptext1").html('Comment Removed sucessfully!!!'); 
													$("#openModalpopup1").css('display','block'); 
													setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
													return false;
												}
						...
						function validate_more_image()
						{
							...
							if(uploadImg.files.length<1)
							{
								...
								$(".ptext1").html('Please select image that you want to add.'); 
								$("#openModalpopup1").css('display','block'); 
								setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
								return false;
							}
						...
						function validate_comment()
						{
							...
							if(msg=='')
							{
								$(".ptext1").html('Please provide Your Comment'); 
								$("#openModalpopup1").css('display','block'); 
								setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
								return false;
							}
...
<script type="text/javascript">
	...
	function mark_reportive_login()
	{
		...
		$(".ptext1").html('Please login to Mark as Abusive.'); 
		$("#openModalpopup1").css('display','block'); 
		setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
		return false;
	}
		...
		if(confirm('Are you sure to perform this action?')==true)
		{
			...
			$.ajax({
					...
					success: function(result){
							...
							{
								$(".mark_action").html(result); 								
								$(".ptext1").html('Mark as Abusive Removed.'); 
								$("#openModalpopup1").css('display','block'); 
								setTimeout(function() { $("#openModalpopup1").fadeOut(1500); }, 5000);
								return false;
							}
