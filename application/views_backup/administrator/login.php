...
<head>
    ...
    <link href="fonts/administrator/css/font-awesome.min.css" rel="stylesheet">
        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <section class="login_content">
                    <form class="login-form" action="<?=base_url()?>administrator/login#crr" method="post">
                        <h1>Login Form</h1>
                        ...
                        <div>
							...
							<?php echo form_error('username','<span class="help-block" id="username-error">'); ?>
                        </div>
                        <div>
                            <input type="password" name="password" class="form-control" placeholder="Password" required="" value="<?php echo set_value('password'); ?>" />
							<?php echo form_error('password','<span class="help-block" id="username-error">'); ?>
                        </div>
                        <div>
                        ...
                        <div class="separator">
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-paw" style="font-size: 26px;"></i> Get Involved</h1>

                                <p>©2015 All Rights Reserved. Get Involved. Privacy and Terms</p>
                            </div>
                        </div>
                    </form>
                    <!-- form -->
